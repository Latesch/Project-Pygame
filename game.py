...
Game = game()
Game.levels[2][2] = (level('data/map/1100_0',Game.player))
Game.levels[3][2] = (level('data/map/1100_0',Game.player))
Game.levels[1][2] = (level('data/map/1100_0',Game.player))
Game.levels[2][3] = (level('data/map/1100_0',Game.player))
Game.levels[2][1] = (level('data/map/1100_0',Game.player))
